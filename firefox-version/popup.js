...
class PopupManager {
  ...
  async ensureContentScript() {
    try {
      ...
      console.log('🔄 Content script ping failed, injecting...', error.message);
    }
    ...
    try {
      ...
      try {
        ...
        console.warn('⚠️ Content script injection may have failed:', e);
        this.showError('Extension may not work on this page. Try refreshing.');
      }
      
    } catch (injectionError) {
      console.error('❌ Failed to inject content script:', injectionError);
      this.showError('Cannot load extension on this page. Try a different page.');
    }
  }
